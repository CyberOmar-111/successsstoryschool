...
export const copy = {
  en: {
    ...
    admissionsTitle: "Step-by-step admissions process",
    admissionsIntro: "Ready to start your child's next chapter? Here's how to take the first step with Success Story School.",
    admissionsPrevious: "Previous admissions step",
    admissionsNext: "Next admissions step",
    admissionsEnquire: "Enquire now",
    admissionsEmail: "Email us",
    stepOne: "Make an enquiry",
    ...
    stepFiveText: "Our team will confirm whether an age-appropriate assessment is needed for your child's grade, explain what to expect, and guide you towards the next step in enrolment.",
    stepFiveAlt: "A Success Story School student learning with an interactive classroom screen",
  ...
  ar: {
    ...
    admissionsTitle: "خطوات القبول والتسجيل",
    admissionsIntro: "هل أنتم مستعدون لفصل جديد في رحلة تعلّم طفلكم؟ إليكم خطوات الانضمام إلى مدرسة قصة نجاح.",
    admissionsPrevious: "خطوة التسجيل السابقة",
    admissionsNext: "خطوة التسجيل التالية",
    admissionsEnquire: "استفسر الآن",
    admissionsEmail: "راسلنا",
    stepOne: "ابدأ باستفسار",
    ...
    stepFiveText: "سيؤكّد فريقنا ما إذا كان صف طفلكم يتطلّب تقييماً مناسباً لعمره، ويوضّح لكم تفاصيله ويساعدكم في استكمال خطوات التسجيل.",
    stepFiveAlt: "طالب في مدرسة قصة نجاح يتعلّم باستخدام شاشة صفية تفاعلية",
