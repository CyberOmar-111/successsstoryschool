...
export const copy = {
  en: {
    ...
    proofText: "Success Story School gives families a clear place to learn about academics, visits, transportation, and school accounts. The goal is simple: help students feel known, supported, and ready for each next step.",
  ...
  ar: {
    ...
    proofText: "تمنح مدرسة قصة نجاح العائلات مكاناً واضحاً لمعرفة الأكاديميات والزيارات والمواصلات وحسابات المدرسة. الهدف بسيط: أن يشعر الطالب بالاهتمام والدعم والاستعداد للخطوة التالية.",
