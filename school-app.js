(() => {
  ...
  function AnimatedDashboardWidget({ children, className = "", index = 0, as = "article", ...props }) {
  ...
  function AcademicsSection({ t }) {
    return /* @__PURE__ */ jsxs("section", { className: "section academics", id: "academics", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "shell card-grid four", children: stages.map(([number2, title, text, gradeRange]) => /* @__PURE__ */ jsxs("article", { className: "info-card stage-card", "data-reveal-card": true, children: [
        /* @__PURE__ */ jsx("span", { className: "card-number", children: number2 }),
  ...
  function AdmissionsSection({ t }) {
    return /* @__PURE__ */ jsxs("section", { className: "section admissions", id: "admissions", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "shell timeline", children: admissions.map(([number2, title, text]) => /* @__PURE__ */ jsxs("article", { className: "timeline-step", "data-reveal-card": true, children: [
        /* @__PURE__ */ jsx("span", { children: number2 }),
        /* @__PURE__ */ jsx("h3", { children: t[title] }),
        /* @__PURE__ */ jsx("p", { children: t[text] })
      ] }, number2)) })
    ] });
  ...
  function HowItWorksSection({ t }) {
    return /* @__PURE__ */ jsxs("section", { className: "section how-works", id: "how-it-works", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "shell how-works-grid", children: howItWorksSteps.map(([number2, title, text]) => /* @__PURE__ */ jsxs("article", { className: "how-step", "data-reveal-card": true, children: [
        /* @__PURE__ */ jsx("span", { children: number2 }),
        /* @__PURE__ */ jsx("h3", { children: t[title] }),
        /* @__PURE__ */ jsx("p", { children: t[text] })
      ] }, number2)) })
  ...
  function PortalPreviewSection({ t }) {
    return /* @__PURE__ */ jsx("section", { className: "portal-preview-section", children: /* @__PURE__ */ jsxs("div", { className: "shell portal-preview-layout", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "dashboard-preview", "aria-label": t.portalPreviewTitle, children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "dashboard-preview-grid", children: portalPreviewRows.map(([label, value, status], index) => /* @__PURE__ */ jsxs(AnimatedDashboardWidget, { className: "dashboard-preview-widget", index, children: [
