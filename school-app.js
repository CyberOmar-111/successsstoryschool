...
const copy = {
  en: {
    ...
    trustEyebrow: "School confidence",
    trustTitle: "Clear information families can rely on.",
    trustText: "The site focuses on information the school can maintain every day: accounts, records, announcements, contact routes, and approved feedback.",
    trustBadgeStack: "Protected student accounts",
    trustBadgeBackend: "Teacher and administrator workspaces",
    trustBadgeDatabase: "Attendance, grades, and homework records",
    trustBadgeSessions: "Announcements from school staff",
    trustBadgePasswords: "Fees and bus request information",
    trustBadgeHonest: "School-approved feedback only",
    faqEyebrow: "FAQ",
