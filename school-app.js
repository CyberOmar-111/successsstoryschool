...
const copy = {
  en: {
    ...
    staffModeText:
      "Teachers and administrators work from protected dashboards connected to the existing backend.",
    ...
    heroCardPointThree: "Class records connected to the backend",
    ...
    proofEyebrow: "Builder story",
    proofTitle: "Built to make school communication calmer.",
    proofText: "I built this site so families can understand the school quickly and staff can manage accounts without scattered messages. It is designed around real workflows: admissions questions, class records, homework, announcements, transportation, and secure account access.",
    proofAcademicsTitle: "Founder-built clarity",
    proofAcademicsText: "The site puts public school information and private account workflows into one calm path instead of separate links and messages.",
    proofPortalTitle: "Technical transparency",
    proofPortalText: "The portal uses HTML, CSS, JavaScript, React UI, a Python backend, HTTP-only sessions, and SQLite locally or Supabase Postgres on Render.",
    ...
    portalPreviewEyebrow: "Account system preview",
    portalPreviewTitle: "A preview of the account tools, not pretend school results.",
    portalPreviewText: "The public site shows the types of records the secure accounts can handle. Actual values stay empty until teachers or administrators post them.",
    ...
    howWorksFollowupText: "The student overview hides empty placeholders as soon as real school data exists, so the page stays useful.",
    feedbackEyebrow: "Beta feedback",
    feedbackTitle: "What early users are saying",
    feedbackText: "No testimonials are published yet. Real quotes will appear here only after families or staff give permission and attribution.",
    feedbackSlotParent: "Quote slot reserved for a parent",
    feedbackSlotTeacher: "Quote slot reserved for a teacher",
    feedbackSlotAdmin: "Quote slot reserved for administration",
    feedbackEmpty: "Awaiting real attributed feedback",
    trustEyebrow: "Trust without fake proof",
    trustTitle: "Transparent signals you can verify today.",
    trustText: "Instead of invented social proof, the site shows the system choices, security posture, and integrations that are already in the project.",
    trustBadgeStack: "HTML, CSS, JavaScript, React UI",
    trustBadgeBackend: "Python backend",
    trustBadgeDatabase: "SQLite local, Supabase Postgres ready",
    trustBadgeSessions: "HTTP-only sessions",
    trustBadgePasswords: "Salted scrypt password hashing",
    trustBadgeHonest: "No fake testimonials or statistics",
    faqEyebrow: "FAQ",
    ...
    faqThreeQ: "Does the portal show fake demo results?",
    faqThreeA: "No. The homepage preview labels the account areas, but the live student dashboard does not invent academic results.",
    faqFourQ: "What database can this use on Render?",
    faqFourA: "Local development uses SQLite. Public deployment can use Supabase Postgres through the DATABASE_URL environment variable.",
...
function App() {
  ...
  return h(
    ...
    h(
      ...
      h(
        "section",
        { className: "section feedback-section", "aria-labelledby": "beta-feedback-title" },
        h(
          "div",
          ...
          h(
            ...
            h("h2", { id: "beta-feedback-title" }, t.feedbackTitle),
